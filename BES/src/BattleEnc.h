...
# define APP_LONGNAME L"BES \x2014 Battle Encoder Shiras\x00E9 1.7.9"
#else
# define APP_NAME "BES - Battle Encoder Shirase"
# define APP_LONGNAME "BES - Battle Encoder Shirase 1.7.9"
#endif
#define APP_HOME_URL TEXT( "https://mion.yosei.fi/BES/" )
#ifdef _MBCS
# undef _MBCS
#endif
...
#  define UNICODE
# endif
# define APP_COPYRIGHT L"Copyright \251 2004" L"\x2013" L"2022 mion"
#else
# ifdef UNICODE
#  undef UNICODE
# endif
# define APP_COPYRIGHT "Copyright (c) 2004-2022 mion"
#endif
